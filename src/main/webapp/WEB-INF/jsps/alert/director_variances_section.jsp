...
<s:if test="!lstCtrl.results.isEmpty">
	<fieldset>
		<legend><a name="director_variances" class="quickLink">Variance Requests Needing Directors Response</a></legend>
		<div class="ccl-list-ctrls clearfix">
			<dts:listcontrols id="licensorVariancesTopControls" name="lstCtrl" action="director-variances" namespace="/home/alerts" useAjax="true" ajaxTarget="#directorVariancesSection"/>
		</div>
		...
		<div class="ccl-list-ctrls clearfix">
			<dts:listcontrols id="licensorVariancesBottomControls" name="lstCtrl" action="director-variances" namespace="/home/alerts" useAjax="true" ajaxTarget="#directorVariancesSection"/>
		</div>
	</fieldset>
</s:if>