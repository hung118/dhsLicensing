...
<s:if test="!lstCtrl.results.isEmpty">
	<fieldset>
		<legend><a name="licensor_variances" class="quickLink">Variance Requests Needing A Licensor Response</a></legend>
		<div class="ccl-list-ctrls clearfix">
			<dts:listcontrols id="licensorVariancesTopControls" name="lstCtrl" action="licensor-variances" namespace="/home/alerts" useAjax="true" ajaxTarget="#licensorVariancesSection"/>
		</div>
		...
		<div class="ccl-list-ctrls clearfix">
			<dts:listcontrols id="licensorVariancesBottomControls" name="lstCtrl" action="licensor-variances" namespace="/home/alerts" useAjax="true" ajaxTarget="#licensorVariancesSection"/>
		</div>
	</fieldset>
</s:if>