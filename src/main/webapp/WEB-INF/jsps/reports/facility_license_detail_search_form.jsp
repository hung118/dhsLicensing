...
<fieldset>
	<legend>Licensor Facility Detail By Licensor</legend>
	<s:actionerror/>
	<h1>Information</h1>
	<div class="subSection">
		This report produces a detail listing of all active status facility licenses for a selected licensor. The report can be 
		filtered to display only licenses that will expire on the date specified by <strong>End Date</strong>. 
	</div>
	...
	<s:form id="licenseRenewalsSearchForm" action="print-facility-license-detail" method="get" cssClass="searchForm">
		<ol class="fieldList">
			<li>
