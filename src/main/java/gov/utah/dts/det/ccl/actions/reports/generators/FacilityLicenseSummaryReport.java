...
public class FacilityLicenseSummaryReport {

	private static final Logger log = LoggerFactory.getLogger(FacilityLicenseSummaryReport.class);
    ...
    public static ByteArrayOutputStream generate(Person specialist, Date endDate, FacilityLicenseSummarySortBy sortBy, List<FacilityLicenseView> licenses) throws Exception {
		ByteArrayOutputStream ba = null;
		try {
			ba = new ByteArrayOutputStream();
			writePdf(specialist, endDate, sortBy, licenses, ba);
		} catch(Exception ex) {
	...
	private static void writePdf(Person specialist, Date endDate, FacilityLicenseSummarySortBy sortBy, List<FacilityLicenseView> licenses, OutputStream ba) throws DocumentException, BadElementException {
	...
	private static PdfPTable getDocumentTable(Person specialist, Date endDate, FacilityLicenseSummarySortBy sortBy) throws DocumentException {
	...
	private static PdfPTable getHeaderTable(Person specialist, Date endDate, FacilityLicenseSummarySortBy sortBy) throws DocumentException {
        Date today = new Date();
		...
		if (sortBy != null && sortBy.equals(FacilityLicenseSummarySortBy.EXPIRE_DATE)) {
			sb.append(" - Expiration Order");
		} else {
			sb.append(" - Name Order");
		}
