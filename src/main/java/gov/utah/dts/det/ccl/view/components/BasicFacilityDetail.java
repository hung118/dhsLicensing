...
public class BasicFacilityDetail extends UIBean {

	public static final String TEMPLATE = "basicfacilitydetail";
	...
	public BasicFacilityDetail(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {
