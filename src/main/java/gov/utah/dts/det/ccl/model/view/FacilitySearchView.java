...
public class FacilitySearchView extends AbstractBaseEntity<Long> implements Serializable, MailingLabel {
	...
	@Column(name = "LICENSING_SPECIALIST_NAME")
	private String licensingSpecialistName;
	...
	public String getLicensingSpecialistName() {
		return licensingSpecialistName;
	}
	
	public void setLicensingSpecialistName(String licensingSpecialistName) {
		this.licensingSpecialistName = licensingSpecialistName;
	}
