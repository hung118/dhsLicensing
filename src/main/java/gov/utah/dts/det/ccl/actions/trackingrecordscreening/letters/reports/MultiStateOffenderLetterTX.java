...
public class MultiStateOffenderLetterTX {

	private static final Logger log = LoggerFactory.getLogger(MultiStateOffenderLetterTX.class);
	...
	private static void writePdf(TrackingRecordScreeningLetter screeningLetter, OutputStream ba, HttpServletRequest request) throws DocumentException, BadElementException, IOException {
        ...
        paragraph = getParagraph();
        paragraph.add(new Phrase("Enclosed are two fingerprint cards for the applicant to provide complete, accurate and legible identifying information. ", mediumfont));
        ...
        paragraph.add(new Phrase("to the Office of Licensing within 15 calendar days of your receipt of this notice. Do not put multiple fingerprints ", mediumfont));
        ...
        procedure.add(item);
        item = getListItem();
        item.add(new Phrase("If mailing the cards back to us, return by regular mail (please do not fold the cards).", mediumfont));
        procedure.add(item);
        item = getListItem();
        ...
        sb = new StringBuilder();
        sb.append("Failure to return the completed fingerprint cards and fee within 15 calendar days will result in the background screening ");
        sb.append("application being denied, and the applicant will not be eligible to be associated with the licensed program in any capacity ");
        ...
        sb = new StringBuilder();
        sb.append("Please allow up to 12 weeks for the completion of the clearance process. For assistance or inquiries, please contact the Office of Licensing ");
