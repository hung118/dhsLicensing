...
@Results({
	@Result(name = "success", location = "/WEB-INF/jsps/alert/director_variances_section.jsp")
})
public class DirectorVariancesAction extends BaseAlertAction implements Preparable {
	...
	public String execute() throws Exception {
		lstCtrl.setResults(varianceService.getDirectorVariances(VarianceAlertSortBy.valueOf(lstCtrl.getSortBy())));
		return SUCCESS;
	}
