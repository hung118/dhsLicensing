...
public enum TrackingRecordScreeningConvictLtrSortBy implements SortBy {
	...
	private TrackingRecordScreeningConvictLtrSortBy(String label, String orderByString, SortDirection defaultSortDirection) {
		this.label = label;
	...
	public static TrackingRecordScreeningConvictLtrSortBy getDefaultSortBy() {
		return LETTER_DATE;
	}
}