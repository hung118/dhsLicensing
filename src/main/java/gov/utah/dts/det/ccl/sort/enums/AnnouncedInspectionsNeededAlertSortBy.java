...
public enum AnnouncedInspectionsNeededAlertSortBy implements SortBy {
...
//	COUNTY("County", "fac.locationAddress.county", SortDirection.ASCENDING),
	...
	LAST_ANNOUNCED_INSPECTION_DATE("Last Announced Inspection Date", "ainv.lastAnnouncedInspectionDate", SortDirection.DESCENDING),
	LAST_UNANNOUNCED_INSPECTION_DATE("Last Unannounced Inspection Date", "ainv.lastUnannouncedInspectionDate", SortDirection.DESCENDING);
	
	private final String label;
	private final String orderByString;
	private final SortDirection defaultSortDirection;
	
	private AnnouncedInspectionsNeededAlertSortBy(String label, String orderByString, SortDirection defaultSortDirection) {
		this.label = label;
	...
	public static AnnouncedInspectionsNeededAlertSortBy getDefaultSortBy() {
