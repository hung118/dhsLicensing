...
public class ExpiredLicensesReport {

	private static final Logger log = LoggerFactory.getLogger(ExpiredLicensesReport.class);
    ...
    public static ByteArrayOutputStream generate(Person specialist, List<FacilityLicenseView> licenses) throws Exception {
		ByteArrayOutputStream ba = null;
		try {
			ba = new ByteArrayOutputStream();
			writePdf(specialist, licenses, ba);
		} catch(Exception ex) {
	...
	private static void writePdf(Person specialist, List<FacilityLicenseView> licenses, OutputStream ba) throws DocumentException, BadElementException {
