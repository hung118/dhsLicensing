...
public enum ExpiredAndExpiringLicensesAlertSortBy implements SortBy {
	...
	APPLICATION_RECEIVED("Application Received", "eelv.licenseExpirationDate", SortDirection.DESCENDING);
	
	private final String label;
	private final String orderByString;
	private final SortDirection defaultSortDirection;
	
	private ExpiredAndExpiringLicensesAlertSortBy(String label, String orderByString, SortDirection defaultSortDirection) {
		this.label = label;
	...
	public static ExpiredAndExpiringLicensesAlertSortBy getDefaultSortBy() {
