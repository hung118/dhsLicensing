...
@Results({
	@Result(name = "success", location = "/WEB-INF/jsps/alert/licensor_variances_section.jsp")
})
public class LicensorVariancesAction extends BaseAlertAction implements Preparable {
	...
	public String execute() throws Exception {
		lstCtrl.setResults(varianceService.getLicensorVariances(VarianceAlertSortBy.valueOf(lstCtrl.getSortBy())));
		return SUCCESS;
	}
